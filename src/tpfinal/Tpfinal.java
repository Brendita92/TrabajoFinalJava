...
public class Tpfinal {
    ...
    public static void main(String[] args) throws Exception  {
		...
		String  url="jdbc:mysql://localhost:3306/personasdb?characterEncoding=utf8";
		String username="root";
		String password="rodri92andres";
		Connection con = null;
		...
		while(true)
		{
			...
			case 4:
				...
				rs=stmt.executeQuery(qry);
                                ...
                                String filePath = "C:" + File.separator + "Users" + File.separator + "Brenda" + File.separator + "Documents" + File.separator + "NetBeansProjects" + File.separator + "tpfinal"+ File.separator + "oradores.xml";;
